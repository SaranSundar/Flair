...
write_to_file("Starting webview")
...
def create_window(title, url=None, html=None, js_api=None, width=800, height=600,
    ...
    write_to_file("Creating window object")
